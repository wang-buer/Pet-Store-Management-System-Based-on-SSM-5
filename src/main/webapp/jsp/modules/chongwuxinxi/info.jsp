						...
						<div class="widget-area-2 lochana-box-shadow">
							...
							<form id="addOrUpdateForm">
								<div class="form-row">
									...
									<input id="chongwubianhao" name="chongwubianhao" class="form-control" v-model="ruleForm.chongwubianhao" readonly>
									</div>
									<div class="form-group col-md-6">
									<label>宠物种类</label>
									...
									<input id="jiankangchengdu" name="jiankangchengdu" class="form-control" v-model="ruleForm.jiankangchengdu" readonly>
									</div>
									<div class="form-group col-md-6">
									<label>宠物图片</label>
