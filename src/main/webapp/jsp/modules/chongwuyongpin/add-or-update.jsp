...
<body>
		...
		<div id="contentText">
				...
				<div class="container mt-0">
					<div class="row breadcrumb-bar">
						<div class="col-md-6">
							<h3 class="block-title">编辑宠物用品</h3>
						</div>
						<div class="col-md-6">
							<ol class="breadcrumb">
								...
								<li class="breadcrumb-item"><span>宠物用品管理</span></li>
								<li class="breadcrumb-item active"><span>编辑宠物用品</span></li>
							</ol>
						</div>
					</div>
				</div>
				...
				<div class="row">
					...
					<div class="col-md-12">
						<div class="widget-area-2 lochana-box-shadow">
							<h3 class="widget-title">宠物用品信息</h3>
							<form id="addOrUpdateForm">
								<div class="form-row">
									...
									<div class="form-group col-md-6">
										<label>用品类型</label>
										<select id="yongpinleixingSelect" name="yongpinleixing" class="form-control">
										</select>	
									</div>	
									<div class="form-group col-md-6">
										<label>品牌</label>
	...
	<script>
		...
		function yongpinleixingSelect(){
			http("option/yongpinleixing/yongpinleixing","GET",{},(res)=>{
				if(res.code == 0){
					yongpinleixingOptions = res.data;
					var nullOption = document.createElement('option');
					var yongpinleixingSelect = document.getElementById('yongpinleixingSelect');
					yongpinleixingSelect.appendChild(nullOption);
					for(var i=0;i<yongpinleixingOptions.length;i++){
						var yongpinleixingOption = document.createElement('option');
						yongpinleixingOption.setAttribute('name','yongpinleixingOption');
						yongpinleixingOption.setAttribute('value',yongpinleixingOptions[i]);
						yongpinleixingOption.innerHTML = yongpinleixingOptions[i];									
						if(ruleForm.yongpinleixing == yongpinleixingOptions[i]){
							yongpinleixingOption.setAttribute('selected','selected');
						}
						yongpinleixingSelect.appendChild(yongpinleixingOption);
					}
				}
			});
		}	
		  ...
		  beforeCreate: function(){
			  var id = window.sessionStorage.getItem("id");
				if(id != null && id != "" && id != "null"){
					$.ajax({ 
		                type: "GET",
		                url: baseUrl + "chongwuyongpin/info/" + id,
				...
				if(crossrefid && crossuserid) {
					...
					http("chongwuyongpin/page","GET",{
						...
						if(res.data.total >= crossoptnum){
							...
							httpJson("chongwuyongpin/"+urlParam,"POST",data,(res)=>{
								if(res.code == 0){
		...
		function getDetails() {
			...
			if(id != null && id != "" && id != "null"){
				updateId = id;
				window.sessionStorage.removeItem('id');
				http("chongwuyongpin/info/" + id,"GET",{},(res)=>{
					if(res.code == 0){
						ruleForm = res.data
						// 是/否下拉框回显
						setSelectOption();
		...
		function calculationSE(colName){
			//单列求和接口
			http("chongwuyongpin"+colName,"GET",{
		...
		function dataBind(){
			...
			var yongpinleixingOptions = document.getElementsByClassName("yongpinleixingOption");
			for(var yongpinleixingCount = 0; yongpinleixingCount < yongpinleixingOptions.length;yongpinleixingCount++){
				if(yongpinleixingOptions[yongpinleixingCount].getAttribute('value') == ruleForm.yongpinleixing){
					yongpinleixingOptions[yongpinleixingCount].setAttribute('selected','selected');
				}
			}
		...
		if(crossTableName != null && crossTableName != '' && crossTableId != null && crossTableId != '' && crossTableId != -1){
			http(crossTableName + "/info/" + crossTableId,"GET",{},(res)=>{
				if(res.code == 0){
					...
					if(res.data != null && res.data != '' && res.data.yongpinleixing != null && res.data.yongpinleixing != ''){

						var yongpinleixingOptions = document.getElementsByClassName("yongpinleixingOption");
						for(var yongpinleixingCount = 0; yongpinleixingCount < yongpinleixingOptions.length;yongpinleixingCount++){
							if(yongpinleixingOptions[yongpinleixingCount].getAttribute('value') == res.data.yongpinleixing){
								yongpinleixingOptions[yongpinleixingCount].setAttribute('selected','selected');
							}
						}
					}
