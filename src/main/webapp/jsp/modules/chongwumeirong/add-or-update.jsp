...
<body>
		...
		<div id="contentText">
				...
				<div class="container mt-0">
					<div class="row breadcrumb-bar">
						<div class="col-md-6">
							<h3 class="block-title">编辑宠物美容</h3>
						</div>
						<div class="col-md-6">
							<ol class="breadcrumb">
								...
								<li class="breadcrumb-item active"><span>编辑宠物美容</span></li>
							</ol>
						</div>
					</div>
				</div>
				...
				<div class="row">
					...
					<div class="col-md-12">
						<div class="widget-area-2 lochana-box-shadow">
							<h3 class="widget-title">宠物美容信息</h3>
							<form id="addOrUpdateForm">
								<div class="form-row">
									<input id="updateId" name="id" type="hidden">
									<div class="form-group col-md-6">
										<label>服务名称</label>
										<input name="fuwumingcheng" id="fuwumingcheng" name="fuwumingcheng" class="form-control" placeholder="服务名称">
									</div>
									<div class="form-group col-md-6">
										<label>图片</label>
									...
									<div class="form-group col-md-6">
										...
										<input name="keyueshijian" id="keyueshijian" name="keyueshijian" class="form-control" placeholder="可约时间">
											...
											<div class="form-group  col-md-12" >
												<label>服务内容</label>
												<div><div class="upload"><input id="fuwuneirongupload" name="file" type="file">选择文件</div>
												<script id="fuwuneirongEditor" type="text/plain"></script>
	...
	<script>
		  ...
		  beforeCreate: function(){
			  var id = window.sessionStorage.getItem("id");
				if(id != null && id != "" && id != "null"){
					$.ajax({ 
		                type: "GET",
		                url: baseUrl + "chongwumeirong/info/" + id,
		...
		function upload(){
			...
			$('#fuwuneirongupload').fileupload({
				url: baseUrl + 'file/upload',
				headers:{ token: window.sessionStorage.getItem("token")},
				dataType: 'json',
				done: function (e, data) {	
					UE.getEditor('fuwuneirongEditor').execCommand('insertHtml','<img src=\"'+ baseUrl +'upload/'+ data.result.file + '\" width=900 height=560>');					
				}
			});
		}  
		//取消 
				...
				if(crossrefid && crossuserid) {
					...
					http("chongwumeirong/page","GET",{
						...
						if(res.data.total >= crossoptnum){
							...
							httpJson("chongwumeirong/"+urlParam,"POST",data,(res)=>{
								if(res.code == 0){
		...
		// 获取富文本框内容
		function getContent(){
			if(UE.getEditor('fuwuneirongEditor').hasContents()){
				$('#fuwuneirong-input').attr('value',UE.getEditor('fuwuneirongEditor').getContent());
			}
		}
		...
		function getDetails() {
			...
			if(id != null && id != "" && id != "null"){
				updateId = id;
				window.sessionStorage.removeItem('id');
				http("chongwumeirong/info/" + id,"GET",{},(res)=>{
					if(res.code == 0){
						ruleForm = res.data
						// 是/否下拉框回显
						setSelectOption();
		...
		function dataBind(){
			...
			$("#fuwumingcheng").val(ruleForm.fuwumingcheng);	
			$("#tupian-input").val(ruleForm.tupian);
			$("#chongwuzhonglei").val(ruleForm.chongwuzhonglei);	
			$("#fuwuneirong").val(ruleForm.fuwuneirong);	
		...
		if(crossTableName != null && crossTableName != '' && crossTableId != null && crossTableId != '' && crossTableId != -1){
			http(crossTableName + "/info/" + crossTableId,"GET",{},(res)=>{
				if(res.code == 0){
					...
					if(res.data != null && res.data != '' && res.data.fuwumingcheng != null && res.data.fuwumingcheng != ''){

						$("#fuwumingcheng").val(res.data.fuwumingcheng);
						$("#fuwumingcheng").attr('readonly','readonly');
					}
					...
					if(res.data != null && res.data != '' && res.data.fuwuneirong != null && res.data.fuwuneirong != ''){

						$("#fuwuneirong").val(res.data.fuwuneirong);
                        var fuwuneirongMes = '' + res.data.fuwuneirong;
                        var fuwuneirongUeditor = UE.getEditor('fuwuneirongEditor');
                        fuwuneirongUeditor.ready(function() {
                            fuwuneirongUeditor.setContent(fuwuneirongMes);
                        });
