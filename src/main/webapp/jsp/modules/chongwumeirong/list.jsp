...
<body>
		...
		<div id="content">
				...
				<div class="container mt-0">
					<div class="row breadcrumb-bar">
						<div class="col-md-6">
							<h3 class="block-title">宠物美容管理</h3>
						</div>
						<div class="col-md-6">
							<ol class="breadcrumb">
								...
								<li class="breadcrumb-item"><span>宠物美容管理</span></li>
								<li class="breadcrumb-item active"><span>宠物美容列表</span></li>
							</ol>
						</div>
					</div>
				</div>
				...
				<div class="row">
					...
					<div class="col-md-12">
						<div class="widget-area-2 lochana-box-shadow">
							<h3 class="widget-title">宠物美容列表</h3>							
							<div class="table-responsive mb-3" id="tableDiv">
								<div class="col-sm-12">
									<label>
										服务名称
									</label>
									<input type="text" id="fuwumingchengSearch" class="form-control form-control-sm" placeholder="请输入服务名称" aria-controls="tableId">
									<label>
										宠物种类
									</label>
									<input type="text" id="chongwuzhongleiSearch" class="form-control form-control-sm" placeholder="请输入宠物种类" aria-controls="tableId">
								...
								<table id="tableId" class="table table-bordered table-striped">
									<thead>
										<tr>
											...
											<th onclick="sort('fuwumingcheng')">服务名称<i id="fuwumingchengIcon" class="fa fa-sort"></i></th>
											<th>图片</th>
	...
	<script>
		...
		function search(){
			searchForm = { key: ""};
			if($('#fuwumingchengSearch').val() != null && $('#fuwumingchengSearch').val() != ''){
				searchForm.fuwumingcheng ="%" +  $('#fuwumingchengSearch').val() + "%";
			}
			
			if($('#chongwuzhongleiSearch').val() != null && $('#chongwuzhongleiSearch').val() != ''){
				searchForm.chongwuzhonglei ="%" +  $('#chongwuzhongleiSearch').val() + "%";
			}
        ...
        function getDataList() {
			http("chongwumeirong/page","GET",{
				page: pageIndex,
				limit: pageSize,
				sort: sortColumn,
				order: sortOrder,
				fuwumingcheng : searchForm.fuwumingcheng,	
		...
		function setDataRow(item,number){
			...
			var fuwumingchengCell  = document.createElement('td');

						 fuwumingchengCell.innerHTML = item.fuwumingcheng;

			row.appendChild(fuwumingchengCell);
			...
			var fuwuneirongCell  = document.createElement('td');
			...
			var crossBtn0 = document.createElement('button');
            		crossBtn0.innerHTML = "美容预约"
			crossBtn0.setAttribute("type","button");
			crossBtn0.setAttribute("class","btn btn-primary btn-sm");
			crossBtn0.setAttribute("onclick","crossTable(" + JSON.stringify(item) + ",'meirongyuyue','','','')");
			if(crossBtnControl('美容预约') == true){
        ...
        function remove(id) { 
            ...
            if (mymessage == true) {
				...
				httpJson("chongwumeirong/delete","POST",paramArray,(res)=>{
					if(res.code == 0){
						getDataList();		
						alert('删除成功');
					}
	...
	function discussList(id) {
            ...
            window.location.href = "../discusschongwumeirong/list.jsp"
        }
		//清除会重复渲染的节点
        function clear(){
	...
	function getSum(colName){
		http("chongwumeirong"+colName,"GET",{
	...
	function crossTable(obj,crossTableName,crossOptAudit,statusColumnName,tips,statusColumnValue){
		...
		window.sessionStorage.setItem('crossTableName',"chongwumeirong");
